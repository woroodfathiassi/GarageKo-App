...
public class ManageCarBillingActivity extends AppCompatActivity {
    ...
    private Button addBillingButton, billingReportButton, ratingBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        billingReportButton.setOnClickListener(v -> {
            Intent intent = new Intent(ManageCarBillingActivity.this, CarBillingReport.class);
            intent.putExtra("ownerName", ownerName);
            intent.putExtra("carModel", carModel);
            intent.putExtra("carImage", carImage);
            intent.putExtra("request_id", request_id);
        ...
        ratingBtn.setOnClickListener(e->{
            Intent intent = new Intent(ManageCarBillingActivity.this, ShowRatingAtOwnerActivity.class);
            intent.putExtra("request_id", request_id);
            startActivity(intent);
        });
    }
